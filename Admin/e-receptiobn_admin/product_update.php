...
<div class="form-group">
    ...
    <input name="price1" type="text"  class="form-control" id="exampleFormControlInput1" value="<?php echo $rows ['price1']?>" placeholder="">
</div>
<div class="form-group">
    <label for="exampleFormControlInput1">Price End</label>
    <input name="price2" type="text"  class="form-control" id="exampleFormControlInput1" value="<?php echo $rows ['price2']?>" placeholder="">
</div>
